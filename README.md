...
| **STTNG** | Solves the shuffling level 201 pk maze above The Imaginarium on Prosper's Island and walks you to any room in it (`sttng`, or `sttng3`). Clickable room list that pops up when you walk into Entering the Theater, including the four side rooms (Stalwart, Brawn, Moriarty, The Bridge), plus `sttngout` to leave. The maze reshuffles every repop and the plugin re-solves it on its own. ⚠️ New — still needs live testing. |
